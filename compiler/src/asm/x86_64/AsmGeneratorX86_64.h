...
public:
    ...
    void ldConstInstrINT8(ostream& o, string reg_src, string reg_dest) override;
    void ldConstInstrINT32(ostream& o, string reg_src, string reg_dest) override;
    void ldConstInstrFLOAT64(ostream& o, string reg_src, string reg_dest) override;
    ...
    void AddINT32_by_FLOAT64(ostream& o, string lhs, string rhs, string dest) override;
    void AddFLOAT64_by_INT32(ostream& o, string lhs, string rhs, string dest) override;
