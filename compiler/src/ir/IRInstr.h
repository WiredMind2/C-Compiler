...
struct LdStringInstr : IRInstr {
    ...
    std::string to_string() const override {
        return "ldstr " + irtype_name(IRType::POINTER) + " " + std::to_string(strIndex) + " -> " + reg_name(dest.reg);
    }
};
...
struct LdConstInstr : IRInstr {
    ...
    LdConstInstr(BasicBlock *bb, const Reg d, const IRType t, int64_t v) : IRInstr(bb, t), dest(d, t), val(t, v) {}

    LdConstInstr(BasicBlock *bb, const Reg d, const IRType t, double v) : IRInstr(bb, t), dest(d, t), val(t, v) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "ldconst." + irtype_name(type) + " " + dest.to_string() + ", " + val.to_string(); }
};
...
struct CopyRegInstr : IRInstr {
    ...
    CopyRegInstr(BasicBlock *bb, const Reg d, const Reg s, const IRType t = IRType::INT32) : IRInstr(bb, t), dest(d, t), src(s, t) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "copy_reg." + irtype_name(type) + " " + dest.to_string() + ", " + src.to_string(); }
};
...
struct StoreStackInstr : IRInstr {
    ...
    StoreStackInstr(BasicBlock *bb, const string &d, const Reg s, const IRType t = IRType::INT32) : IRInstr(bb, t), dest(d, t), src(s, t) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "store_stack." + irtype_name(type) + " " + dest.to_string() + ", " + src.to_string(); }
};
...
struct LoadStackInstr : IRInstr {
    ...
    LoadStackInstr(BasicBlock *bb, const Reg d, const string &s, const IRType t = IRType::INT32) : IRInstr(bb, t), dest(d, t), src(s, t) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "load_stack." + irtype_name(type) + " " + dest.to_string() + ", " + src.to_string(); }
};
...
struct AddressOfSymbolInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override { return "address_of." + irtype_name(type) + " " + dest.to_string() + ", " + src.to_string(); }
};
...
struct LoadPointerInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override { return "load_ptr." + irtype_name(type) + " " + dest.to_string() + ", " + ptr.to_string(); }
};
...
struct StorePointerInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override { return "store_ptr." + irtype_name(type) + " " + ptr.to_string() + ", " + src.to_string(); }
};
...
struct AddInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "add." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct SubInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "sub." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct MulInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "mul." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct DivInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "div." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct ModInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "mod." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct BitNotInstr : IRInstr {
    ...
    BitNotInstr(BasicBlock *bb, const Reg d, const Reg s, const IRType t = IRType::INT32) : IRInstr(bb, t), dest(d, t), src(s, t) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "bit_not." + irtype_name(type) + " " + dest.to_string() + ", " + src.to_string(); }
};
...
struct BitAndInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "bit_and." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct BitOrInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "bit_or." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct BitXorInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "bit_xor." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct ShlInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "shl." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct ShrInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "shr." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct CmpEqInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "cmp_eq." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct CmpLtInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "cmp_lt." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct CmpLeInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "cmp_le." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct CmpGtInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "cmp_gt." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct CmpGeInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "cmp_ge." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct LogicalAndInstr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override {
        return "logical_and." + irtype_name(type) + " " + dest.to_string() + ", " + lhs.to_string() + ", " + rhs.to_string();
    }
};
...
struct CallInstr : IRInstr {
    ...
    CallInstr(BasicBlock *bb, string label, const Reg d, const vector<Reg> &argRegs, const vector<IRType> &argTypes, const IRType t = IRType::INT32)
    ...
    [[nodiscard]] string to_string() const override {
        string s = "call." + irtype_name(type) + " " + dest.to_string() + " = " + funcLabel + "(";
...
struct F64ToI32Instr : IRInstr {
    ...
    F64ToI32Instr(BasicBlock *bb, const Reg d, const Reg s) : IRInstr(bb, IRType::INT32), dest(d, IRType::INT32), src(s, IRType::FLOAT64) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "ftoi " + dest.to_string() + ", " + src.to_string(); }
};
...
struct I32ToF64Instr : IRInstr {
    ...
    I32ToF64Instr(BasicBlock *bb, const Reg d, const Reg s) : IRInstr(bb, IRType::FLOAT64), dest(d, IRType::FLOAT64), src(s, IRType::INT32) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "i32_to_f64 " + dest.to_string() + ", " + src.to_string(); }
};
...
struct FToIInstr : IRInstr {
    ...
    FToIInstr(BasicBlock *bb, const Reg d, const Reg s) : IRInstr(bb, IRType::INT32), dest(d, IRType::INT32), src(s, IRType::FLOAT64) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "f_to_i " + dest.to_string() + ", " + src.to_string(); }
};
...
struct I8ToI32Instr : IRInstr {
    ...
    [[nodiscard]] string to_string() const override { return "i8_to_i32 " + dest.to_string() + ", " + src.to_string(); }
};
...
struct I32ToI8Instr : IRInstr {
    ...
    I32ToI8Instr(BasicBlock *bb, const Reg d, const Reg s) : IRInstr(bb, IRType::INT8), dest(d, IRType::INT8), src(s, IRType::INT32) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "i32_to_i8 " + dest.to_string() + ", " + src.to_string(); }
};

/** Return — the return value must already be in Reg::RET */
struct RetInstr : IRInstr {
    explicit RetInstr(BasicBlock *bb, const IRType t = IRType::INT32) : IRInstr(bb, t) {}

    void accept(AsmGenerator &g, ostream &o) override;

    [[nodiscard]] string to_string() const override { return "ret." + irtype_name(type); }
};
